    ...
    <main className="flex flex-col min-h-screen bg-white px-6 pt-12 pb-6 max-w-sm mx-auto w-full border relative">
        ...
        <div className="flex items-center justify-center w-full max-w-[180px] mx-auto mb-8 relative">
          <div
            className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm z-10 transition-colors ${
              step >= 1 ? "bg-[#2e7d32] text-white" : "bg-gray-200 text-gray-500"
            }`}
          >
            1
          </div>
          <div
            className={`flex-1 h-0.5 z-0 -mx-1 transition-colors ${
              step >= 2 ? "bg-[#2e7d32]" : "bg-gray-200"
            }`}
          />
          <div
            className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm z-10 transition-colors ${
              step >= 2 ? "bg-[#2e7d32] text-white" : "bg-gray-200 text-gray-500"
            }`}
          >
            2
          </div>
      ...
      {step === 1 && (
        <div className="flex flex-col flex-1">
          ...
          <p className="text-center text-gray-500 text-xs leading-relaxed mb-8 px-4">
            Please choose your primary license type so we can customize your dashboard and match you with the right clients.
          </p>
          ...
          <div className="relative mb-8 z-50">
            <button
              ...
              className={`w-full bg-gray-50 rounded-2xl py-5 px-6 text-gray-700 text-sm outline-none border-2 transition-all flex justify-between items-center ${
                profession ? "border-[#2e7d32]" : "border-gray-200"
              }`}
            >
          ...
          <div className="mt-auto pt-6">
            <button
              ...
              disabled={!profession}
              onClick={() => setStep(2)}
              className="w-full bg-[#2e7d32] disabled:bg-gray-300 disabled:cursor-not-allowed hover:bg-[#1b5e20] active:bg-[#1b5e20] text-white font-bold text-lg rounded-2xl py-4 transition-colors shadow-sm"
            >
              Continue
            </button>
          </div>
        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="space-y-3 mb-6">
            {reqDocs.map((doc) => {
              ...
              return (
                <label
                  key={doc}
                  className={`w-full bg-gray-100 rounded-2xl py-4 px-6 text-sm border transition-all flex items-center justify-between cursor-pointer ${
                    isUploaded
          ...
          <div className="flex gap-3 mt-auto pt-6">
            <button
              type="button"
              onClick={() => setStep(1)}
              className="flex-1 bg-white border border-[#2e7d32] hover:bg-gray-50 active:bg-gray-100 text-[#2e7d32] font-bold text-lg rounded-2xl py-4 transition-colors shadow-sm flex items-center justify-center"
            >
              Back
            </button>
            <button
              ...
              onClick={() => setStep(3)}
              className="flex-1 bg-[#2e7d32] disabled:bg-gray-300 disabled:cursor-not-allowed hover:bg-[#1b5e20] active:bg-[#1b5e20] text-white font-bold text-lg rounded-2xl py-4 transition-colors shadow-sm"
            >
              Continue
            </button>
          </div>
