      ...
      <div className="px-6 py-8 flex-1">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm leading-relaxed">
            Please read this document carefully before creating an account or using Recova.
          </p>
        </div>
        ...
        <div className="space-y-8 text-sm text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <p className="pl-10">
              Recova is a self-guided digital tool designed to help you track your recovery progress and build healthier habits related to reducing pornography use. It offers a private, supportive space that includes progress tracking, educational content, and an in-app crisis-support feature intended to help you get through moments of urge or distress.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="pl-10 mb-4">
              Recova is a self-help and habit-tracking tool. It is not a licensed medical, psychological, or addiction-treatment service, and using it does not create a therapist-client, doctor-patient, or counseling relationship.
            </p>
          ...
          <section>
            ...
            <p className="pl-10 mb-3">
              Recova offers an optional feature that allows you to connect with a licensed psychologist or other licensed mental health professional ("Provider") through the app. Please review the following before using this feature:
            </p>
            <ul className="list-disc pl-14 space-y-2 text-gray-500 mb-4">
              <li><strong className="text-gray-700">Separate professional relationship:</strong> Once you connect with a Provider, a genuine therapist-client relationship is formed between you and that Provider — not between you and Recova. The Provider, not Recova, is responsible for the care they provide.</li>
              <li><strong className="text-gray-700">Recova's role:</strong> Recova's role is limited to facilitating the connection and is not itself practicing medicine or psychology.</li>
              <li><strong className="text-gray-700">Provider credentials:</strong> Providers made available through Recova are represented to hold applicable licenses in good standing. You are encouraged to independently verify a Provider's license.</li>
            ...
            <p className="pl-10 mb-4">
              Using this feature is optional. You may continue using Recova's self-tracking and crisis-support tools without ever connecting with a Provider, and you may stop working with a Provider at any time.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="pl-10">
              Your use of Recova is entirely voluntary. You may pause, stop, or delete your account and data at any time. You are free to decide how much information you share, and you are not obligated to disclose anything you are not comfortable sharing.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="pl-10 mb-3">
              Recova collects information you provide in order to operate the app's core features. We treat this information as sensitive and:
            </p>
            <ul className="list-disc pl-14 space-y-2 text-gray-500">
          ...
          <section>
            ...
            <p className="pl-10">
              You may withdraw your consent and discontinue use of Recova at any time. You can delete your account and associated data through the app's settings or by contacting our support team.
            </p>
          </section>
        </div>
      </div>
