...
export default function Question5Page() {
  ...
  function handleContinue() {
    setOnboardingAnswer("usage_increase", selected!);
  ...
  return (
    <main className="flex flex-col min-h-screen bg-white px-6 max-w-sm mx-auto w-full border">
      {/* Back button */}
      <Link href="/onboarding/question-4" className="mt-6 inline-flex items-center gap-1 text-gray-500 hover:text-gray-700 active:text-gray-700 transition-colors w-fit">
