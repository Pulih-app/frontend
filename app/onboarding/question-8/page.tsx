...
export default function Question9Page() {
  ...
  function handleContinue() {
    setOnboardingAnswer("tried_to_reduce", selected!);
  ...
  return (
    <main className="flex flex-col min-h-screen bg-white px-6 max-w-sm mx-auto w-full border">
      ...
      {/* Question label */}
      <p className="mt-4 text-[#2e7d32] font-semibold text-base">Question 8 / 8</p>

      {/* Question heading */}
      <h1 className="mt-3 text-[2rem] font-extrabold text-gray-900 leading-tight">
        Have you ever tried to reduce watching pornography before?
      </h1>
