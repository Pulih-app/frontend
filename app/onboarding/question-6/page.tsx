...
export default function Question7Page() {
  ...
  return (
    <main className="flex flex-col min-h-screen bg-white px-6 max-w-sm mx-auto w-full border">
      {/* Back button */}
      <Link href="/onboarding/question-5" className="mt-6 inline-flex items-center gap-1 text-gray-500 hover:text-gray-700 active:text-gray-700 transition-colors w-fit">
      ...
      {/* Question label */}
      <p className="mt-4 text-[#2e7d32] font-semibold text-base">Question 6 / 8</p>

      {/* Question heading */}
      <h1 className="mt-3 text-[2rem] font-extrabold text-gray-900 leading-tight">
        Do you watch pornography to escape feeling sad?
      </h1>
