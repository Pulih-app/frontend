...
export default function Question3Page() {
  ...
  return (
    <main className="flex flex-col min-h-screen bg-white px-6 max-w-sm mx-auto w-full border">
      {/* Back button */}
      <Link href="/onboarding/question-2" className="mt-6 inline-flex items-center gap-1 text-gray-500 hover:text-gray-700 active:text-gray-700 transition-colors w-fit">
      ...
      {/* Question label */}
      <p className="mt-4 text-[#2e7d32] font-semibold text-base">Question 3 / 8</p>
      ...
      <div className="mt-auto w-full pb-8 pt-6">
        {selected ? (
          <Button href="/onboarding/question-4">Continue</Button>
        ) : (
